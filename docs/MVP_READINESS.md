...
| Microphone panel     | Partial | Local-only privacy copy and the recording control rendered. Permission and recording were not activated during automated review. |
...
2. Allow and deny microphone permission, record a short sample, replay it, remove it, and confirm it
   disappears after leaving the game.
